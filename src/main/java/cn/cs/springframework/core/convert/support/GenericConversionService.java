...
public class GenericConversionService implements ConversionService, ConverterRegistry {
    ...
    private GenericConverter.ConvertiblePair getRequiredTypeInfo(Object objet) {
        Type[] genericInterfaces = objet.getClass().getGenericInterfaces();
    ...
    private final class ConverterAdapter implements GenericConverter {
        ...
        @Override
        public Object convert(Object source, Class<?> sourceTpe, Class<?> targetType) {
